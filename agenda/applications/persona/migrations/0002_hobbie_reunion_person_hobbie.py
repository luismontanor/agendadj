# Generated by Django 4.1.2 on 2022-10-23 05:27
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hobbie', models.CharField(max_length=50, verbose_name='Pasatiempo')),
            ],
            options={
                'verbose_name': 'Hobbie',
        ...
        migrations.AddField(
            model_name='person',
            name='hobbie',
            field=models.ManyToManyField(to='persona.hobbie'),
        ),
    ]
